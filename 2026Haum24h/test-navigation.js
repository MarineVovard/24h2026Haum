...
function runTests() {
    ...
    const move1 = SmartNavigation.getNextMoveGreedy([0, 0], // Départ
    [0, 10], // Cible (Nord)
    [], // Pas d'obstacles
    5, // maxSpeed
    ...
    const obstacles2 = [[0, 5]]; // Obstacle en plein millieu
    const move2 = SmartNavigation.getNextMoveGreedy([0, 0], // Départ
    [0, 10], // Cible (Nord)
    obstacles2, 5, // maxSpeed
    ...
    const obstacles3 = [[0, 2]];
    const move3 = SmartNavigation.getNextMoveGreedy([0, 0], // Départ
    [0, 4], // Cible (Nord)
    obstacles3, 5, // maxSpeed (5 > 4 donc il voudrait y aller direct)
    1.5 // Rayon
    );
